"""
Django settings for secure_manager project.
...
MIDDLEWARE = [
    ...
    # Keep CSRF middleware for Django admin/forms (not enforced on API)
...
ROOT_URLCONF = 'secure_manager.urls'
...
# Argon2 as password hasher (install argon2-cffi)
PASSWORD_HASHERS = [
    'django.contrib.auth.hashers.Argon2PasswordHasher',
    'django.contrib.auth.hashers.PBKDF2PasswordHasher',
]

# CORS - allow frontend dev origin (angular dev server)
...
# REST_FRAMEWORK = {
#     'DEFAULT_AUTHENTICATION_CLASSES': (
#         'vault.auth.CookieJWTAuthentication',   # <<-- custom auth that reads cookie
#     ),
# }
